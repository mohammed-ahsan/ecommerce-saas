      ...
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                <h6 className="text-gray-800 font-medium mb-1">Products</h6>
                <ul>
                  <li className="mb-1">
              ...
              {/* 3rd block */}
              <div className="text-sm">
                <h6 className="text-gray-800 font-medium mb-1">Resources</h6>
                <ul>
                  <li className="mb-1">
              ...
              {/* 4th block */}
              <div className="text-sm">
                <h6 className="text-gray-800 font-medium mb-1">Company</h6>
                <ul>
                  <li className="mb-1">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; EcommerceSaas. All rights reserved.</div>
